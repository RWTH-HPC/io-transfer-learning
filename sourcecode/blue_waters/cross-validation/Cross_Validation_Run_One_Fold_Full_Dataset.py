...
def main(fold):
    ...
    # ## Load the data
    DATASET_DIR = rf"/data/blue_waters_dataset/cross_validation/{config.num_folds}-fold/{KFOLD_SEED}"
    ...
    MODEL_DIR = Path(rf"/models/blue_waters/cross_val/regular/{config.num_folds}-fold/{KFOLD_SEED}")
